...
class KnowledgeComponent(Component):
    ...
    def get_summary(self):
        ...
        conversation_info = ". ".join(self.conversation_memories[-5:])  # Get the last 5 conversation memories
        return f"Known Actors: {actor_info}. Known locations: {location_info}. Recent conversations: {conversation_info}"
